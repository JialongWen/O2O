...
import com.wjl.o2o.dto.UserAccessToken;
import com.wjl.o2o.dto.WechatInfo;
import com.imooc.o2o.entity.*;
import com.wjl.o2o.entity.*;
...
import com.wjl.o2o.service.WechatAuthService;
import com.wjl.o2o.util.CodeUtil;
import com.wjl.o2o.util.HttpServletRequestUtil;
import com.wjl.o2o.util.baidu.ShortNetAddress;
import com.wjl.o2o.util.wechat.WechatUtil;
...
public class ShopAuthManagementController {
    ...
    private void generateQRCode4shopAuth(HttpServletRequest request, HttpServletResponse response){
        //从session里获得当前shop的信息
        Shop shop = (Shop)request.getSession().getAttribute("currentShop");
        if(shop != null && shop.getShopId() != null){
            //获取当前时间戳,以保证二维码的时间有效期，精确到毫秒
            ...
            try{
                ...
                String shortUrl = ShortNetAddress.getShortURL(new LongUrl(longUrl));
                //调用二维码生成的工具方法，传入短的URL,生成二维码
    ...
    /**
     * 根据二维码携带的createTime是否已经超过十分钟 如果超过提示过期
     * @param wechatInfo
     * @return
     */
    ...
    private WechatAuth getEmployeeInfo(HttpServletRequest request) {
        ...
        if(null != code){
            ...
            request.getSession().setAttribute("oppenId",openId);
